...
int main(){
    ...
    //Nome do jogo. 
    set_window_title("Lord of Death");
   ...
   //personagens
   personagem    = load_bitmap("imgs\\personagem3.bmp",NULL);
   personagem2   = load_bitmap("imgs\\personagem3.bmp",NULL);
   irmao         = load_bitmap("imgs\\irmao.bmp",NULL);
   irmaocenario  = load_bitmap("imgs\\irmaocenario.bmp",NULL);
   persoatk      = load_bitmap("imgs\\Atakperson3.bmp",NULL);
   inimigo       = load_bitmap("imgs\\SPmal4.bmp",NULL);
   inimigodnv    = load_bitmap("imgs\\SPmal4.bmp",NULL);
   inimigo2      = load_bitmap("imgs\\SPmal6.bmp",NULL);
   chefaoprimeiro= load_bitmap("imgs\\chefaoprimeiro.bmp",NULL);
   chefaosegundo = load_bitmap("imgs\\chefaosegundo.bmp",NULL);
   //irmao      = load_bitmap("chefao.bmp",NULL);
   
   //menu ou gameover
   gameover            = load_bitmap("imgs\\gameover.bmp",NULL);
   decisao             = load_bitmap("imgs\\decisao.bmp",NULL);
    sair               = load_bitmap("imgs\\sair.bmp",NULL);
    sairvolta          = load_bitmap("imgs\\sair.bmp",NULL);
   textocreditos       = load_bitmap("imgs\\textocreditos.bmp",NULL);
   textoPressY         = load_bitmap("imgs\\textoPressY.bmp",NULL);
    textoInstrucional  = load_bitmap("imgs\\textoInstrucional.bmp",NULL);
    space              = load_bitmap("imgs\\space.bmp",NULL);
    textoPressF        = load_bitmap("imgs\\textoPressF.bmp",NULL);
    voltar             = load_bitmap("imgs\\voltar.bmp",NULL);
   menus               = load_bitmap("imgs\\Menu.bmp",NULL);
   menusvolta          = load_bitmap("imgs\\Menu.bmp",NULL);
   creditos            = load_bitmap("imgs\\creditos.bmp",NULL);
   PS                  = load_bitmap("imgs\\PS.bmp",NULL);         
   //parte dos fundos
   fundo         = load_bitmap("imgs\\fundocavern.bmp",NULL);
   fundodnv      = load_bitmap("imgs\\fundocavern.bmp",NULL);
   fundo2        = load_bitmap("imgs\\carvernaup.bmp",NULL);
   paredefalsa   = load_bitmap("imgs\\colisao.bmp",NULL);
   fundo3SairCavF= load_bitmap("imgs\\saindocavF.bmp",NULL);
   fundo3SairCavA= load_bitmap("imgs\\saindocavA.bmp",NULL);
   pontecastelo  = load_bitmap("imgs\\pontecastelo.bmp",NULL);
   castelo       = load_bitmap("imgs\\castelo.bmp",NULL);
   quartocastelo = load_bitmap("imgs\\quartocastelo.bmp",NULL);
   poraoCastelo = load_bitmap("imgs\\poraoCastelo.bmp",NULL);
    //vidas
    vida         = load_bitmap("imgs\\vida.bmp",NULL);
    vidaini      = load_bitmap("imgs\\vida.bmp",NULL);
    NOT          = load_bitmap("imgs\\NOT.bmp",NULL);
    vidaRenova   = load_bitmap("imgs\\vida.bmp",NULL);
    vida1        = load_bitmap("imgs\\vida-1.bmp",NULL);
    vida2        = load_bitmap("imgs\\vida-2.bmp",NULL);  
    //baus e cenarios que interagem
    bau          = load_bitmap("imgs\\bau.bmp",NULL);  
    bauaberto    = load_bitmap("imgs\\bauaberto.bmp",NULL);
    baufechado   = load_bitmap("imgs\\bau.bmp",NULL); 
    baucore      = load_bitmap("imgs\\baucore.bmp",NULL);   
    armarioNormal= load_bitmap("imgs\\armarioNormal.bmp",NULL);
    armarioAberto= load_bitmap("imgs\\armarioAberto.bmp",NULL);   
   //arvores
    folhas       = load_bitmap("imgs\\folhas.bmp",NULL); 
    toco         = load_bitmap("imgs\\toco.bmp",NULL);  
   //toturiais
    tutorial     = load_bitmap("imgs\\tutorial.bmp",NULL);
    //historias   
    historiainicio= load_bitmap("imgs\\HistoriaInicial.bmp",NULL); 
       Imagensdahistoria  = load_bitmap("imgs\\Imagensdahistoria.bmp",NULL);    
       Imagensdahistoria2 = load_bitmap("imgs\\Imagensdahistoria2.bmp",NULL); 
       setadireita        = load_bitmap("imgs\\setadireita.bmp",NULL);       
       spacehist          = load_bitmap("imgs\\spacehist.bmp",NULL);
       paracontinuar      = load_bitmap("imgs\\paracontinuar.bmp",NULL);
       historiafinal      = load_bitmap("imgs\\historiafinal.bmp",NULL);
 //===vidas chefao====
 vidachefao      = load_bitmap("imgs\\vidachefao.bmp",NULL); 
 vidachefao1     = load_bitmap("imgs\\vidachefao-1.bmp",NULL); 
 vidachefao2     = load_bitmap("imgs\\vidachefao-2.bmp",NULL); 
 vidachefao3     = load_bitmap("imgs\\vidachefao-3.bmp",NULL);
 vidachefao4     = load_bitmap("imgs\\vidachefao-4.bmp",NULL); 
 vidachefao5     = load_bitmap("imgs\\vidachefao-5.bmp",NULL); 
 vidachefao6     = load_bitmap("imgs\\vidachefao-6.bmp",NULL); 
 vidachefao7     = load_bitmap("imgs\\vidachefao-7.bmp",NULL); 
 vidachefaofinal = load_bitmap("imgs\\vidachefao-final.bmp",NULL);
 vidachefaodnv   = load_bitmap("imgs\\vidachefao.bmp",NULL);  
  
 //SONS
  // proerdSamp = load_sample("proerdwav.wav");
   proerd = load_midi("som\\PROERD.mid");
   musica = load_midi("som\\Radioactive.mid");
   battleboss = load_midi("som\\BossBattle.mid"); 
...
//=========Aqui mostra como irá parar o menu=============
void start(){
   if(key[KEY_SPACE]){              
     //troca a musica;                    
       play_midi(musica,1);
...
void menu(){
 ...
 //Aqui é aonde inicia o menu- S_N liga e desliga o Menu 
    if(S_N==1){ 
     while(!key[KEY_SPACE]){
         if(key[KEY_N]){break;}
//contador
...
//CONFIGURAÇÃO DOS ATAQUES DO PERSONAGEM
void ataque(){
